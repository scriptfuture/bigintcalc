...
var option2toDC=document.createElement("option");
option2toDC.value="2toDC";
option2toDC.text="двоичное число в двоичный дополнительный код"; 
selectActionOne.add(option2toDC);

var option2toDC16=document.createElement("option");
option2toDC16.value="2toDC16";
option2toDC16.text="двоичное число в 16-тиричный дополнительный код"; 
selectActionOne.add(option2toDC16);
*/
